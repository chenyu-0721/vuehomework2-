          ...
          <div class="card-body" v-if="!isLogin">
            ...
            <form @submit.prevent="handleSubmit">
              ...
              <div class="mb-3">
                ...
                <input type="password" id="password" v-model="password" class="form-control" placeholder="輸入密碼" required>
              </div>
              <div v-if="isRegister" class="mb-3">
                <label for="nickname" class="form-label">暱稱</label>
                <input type="text" id="nickname" v-model="nickname" class="form-control" placeholder="輸入暱稱" required>
              </div>
              <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary" @click="isRegister ? signUp() : login()">
                  {{ isRegister ? '註冊' : '登入' }}
                </button>
